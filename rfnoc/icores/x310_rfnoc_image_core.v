...
//
// File generated on: 2022-06-26T10:15:44.348895
...
module rfnoc_image_core #(
  ...
  wire [31:0] m_conv32Bto2B0_ctrl_tdata,  s_conv32Bto2B0_ctrl_tdata;
  wire        m_conv32Bto2B0_ctrl_tlast,  s_conv32Bto2B0_ctrl_tlast;
  wire        m_conv32Bto2B0_ctrl_tvalid, s_conv32Bto2B0_ctrl_tvalid;
  wire        m_conv32Bto2B0_ctrl_tready, s_conv32Bto2B0_ctrl_tready;
  wire [31:0] m_PulseShapingFilter0_ctrl_tdata,  s_PulseShapingFilter0_ctrl_tdata;
  wire        m_PulseShapingFilter0_ctrl_tlast,  s_PulseShapingFilter0_ctrl_tlast;
  wire        m_PulseShapingFilter0_ctrl_tvalid, s_PulseShapingFilter0_ctrl_tvalid;
  wire        m_PulseShapingFilter0_ctrl_tready, s_PulseShapingFilter0_ctrl_tready;
  ...
  axis_ctrl_crossbar_nxn #(
    ...
    .s_axis_tdata     ({m_PulseShapingFilter0_ctrl_tdata , m_conv32Bto2B0_ctrl_tdata , m_radio1_ctrl_tdata , m_ddc1_ctrl_tdata , m_duc1_ctrl_tdata , m_radio0_ctrl_tdata , m_ddc0_ctrl_tdata , m_duc0_ctrl_tdata , m_ep0_ctrl_tdata , m_core_ctrl_tdata }),
    .s_axis_tvalid    ({m_PulseShapingFilter0_ctrl_tvalid, m_conv32Bto2B0_ctrl_tvalid, m_radio1_ctrl_tvalid, m_ddc1_ctrl_tvalid, m_duc1_ctrl_tvalid, m_radio0_ctrl_tvalid, m_ddc0_ctrl_tvalid, m_duc0_ctrl_tvalid, m_ep0_ctrl_tvalid, m_core_ctrl_tvalid}),
    .s_axis_tlast     ({m_PulseShapingFilter0_ctrl_tlast , m_conv32Bto2B0_ctrl_tlast , m_radio1_ctrl_tlast , m_ddc1_ctrl_tlast , m_duc1_ctrl_tlast , m_radio0_ctrl_tlast , m_ddc0_ctrl_tlast , m_duc0_ctrl_tlast , m_ep0_ctrl_tlast , m_core_ctrl_tlast }),
    .s_axis_tready    ({m_PulseShapingFilter0_ctrl_tready, m_conv32Bto2B0_ctrl_tready, m_radio1_ctrl_tready, m_ddc1_ctrl_tready, m_duc1_ctrl_tready, m_radio0_ctrl_tready, m_ddc0_ctrl_tready, m_duc0_ctrl_tready, m_ep0_ctrl_tready, m_core_ctrl_tready}),
    .m_axis_tdata     ({s_PulseShapingFilter0_ctrl_tdata , s_conv32Bto2B0_ctrl_tdata , s_radio1_ctrl_tdata , s_ddc1_ctrl_tdata , s_duc1_ctrl_tdata , s_radio0_ctrl_tdata , s_ddc0_ctrl_tdata , s_duc0_ctrl_tdata , s_ep0_ctrl_tdata , s_core_ctrl_tdata }),
    .m_axis_tvalid    ({s_PulseShapingFilter0_ctrl_tvalid, s_conv32Bto2B0_ctrl_tvalid, s_radio1_ctrl_tvalid, s_ddc1_ctrl_tvalid, s_duc1_ctrl_tvalid, s_radio0_ctrl_tvalid, s_ddc0_ctrl_tvalid, s_duc0_ctrl_tvalid, s_ep0_ctrl_tvalid, s_core_ctrl_tvalid}),
    .m_axis_tlast     ({s_PulseShapingFilter0_ctrl_tlast , s_conv32Bto2B0_ctrl_tlast , s_radio1_ctrl_tlast , s_ddc1_ctrl_tlast , s_duc1_ctrl_tlast , s_radio0_ctrl_tlast , s_ddc0_ctrl_tlast , s_duc0_ctrl_tlast , s_ep0_ctrl_tlast , s_core_ctrl_tlast }),
    .m_axis_tready    ({s_PulseShapingFilter0_ctrl_tready, s_conv32Bto2B0_ctrl_tready, s_radio1_ctrl_tready, s_ddc1_ctrl_tready, s_duc1_ctrl_tready, s_radio0_ctrl_tready, s_ddc0_ctrl_tready, s_duc0_ctrl_tready, s_ep0_ctrl_tready, s_core_ctrl_tready}),
    .deadlock_detected()
  );
  ...
  wire              conv32Bto2B0_ce_clk;
  wire [CHDR_W-1:0] s_conv32Bto2B0_in_tdata ;
  wire              s_conv32Bto2B0_in_tlast ;
  wire              s_conv32Bto2B0_in_tvalid;
  wire              s_conv32Bto2B0_in_tready;
  wire [CHDR_W-1:0] m_conv32Bto2B0_out_tdata ;
  wire              m_conv32Bto2B0_out_tlast ;
  wire              m_conv32Bto2B0_out_tvalid;
  wire              m_conv32Bto2B0_out_tready;
  ...
  rfnoc_block_conv32Bto2B #(
    ...
    .rfnoc_chdr_clk      (rfnoc_chdr_clk),
    .rfnoc_ctrl_clk      (rfnoc_ctrl_clk),
    .ce_clk              (conv32Bto2B0_ce_clk),
    .rfnoc_core_config   (rfnoc_core_config[512*7-1:512*6]),
    .rfnoc_core_status   (rfnoc_core_status[512*7-1:512*6]),
    .s_rfnoc_chdr_tdata  ({s_conv32Bto2B0_in_tdata }),
    .s_rfnoc_chdr_tlast  ({s_conv32Bto2B0_in_tlast }),
    .s_rfnoc_chdr_tvalid ({s_conv32Bto2B0_in_tvalid}),
    .s_rfnoc_chdr_tready ({s_conv32Bto2B0_in_tready}),
    .m_rfnoc_chdr_tdata  ({m_conv32Bto2B0_out_tdata }),
    .m_rfnoc_chdr_tlast  ({m_conv32Bto2B0_out_tlast }),
    .m_rfnoc_chdr_tvalid ({m_conv32Bto2B0_out_tvalid}),
    .m_rfnoc_chdr_tready ({m_conv32Bto2B0_out_tready}),
    .s_rfnoc_ctrl_tdata  (s_conv32Bto2B0_ctrl_tdata),
    .s_rfnoc_ctrl_tlast  (s_conv32Bto2B0_ctrl_tlast),
    .s_rfnoc_ctrl_tvalid (s_conv32Bto2B0_ctrl_tvalid),
    .s_rfnoc_ctrl_tready (s_conv32Bto2B0_ctrl_tready),
    .m_rfnoc_ctrl_tdata  (m_conv32Bto2B0_ctrl_tdata),
    .m_rfnoc_ctrl_tlast  (m_conv32Bto2B0_ctrl_tlast),
    .m_rfnoc_ctrl_tvalid (m_conv32Bto2B0_ctrl_tvalid),
    .m_rfnoc_ctrl_tready (m_conv32Bto2B0_ctrl_tready)
  );
  ...
  wire              PulseShapingFilter0_ce_clk;
  wire [CHDR_W-1:0] s_PulseShapingFilter0_in_tdata ;
  wire              s_PulseShapingFilter0_in_tlast ;
  wire              s_PulseShapingFilter0_in_tvalid;
  wire              s_PulseShapingFilter0_in_tready;
  wire [CHDR_W-1:0] m_PulseShapingFilter0_out_tdata ;
  wire              m_PulseShapingFilter0_out_tlast ;
  wire              m_PulseShapingFilter0_out_tvalid;
  wire              m_PulseShapingFilter0_out_tready;

  rfnoc_block_PulseShapingFilter #(
    .THIS_PORTID         (9),
    .CHDR_W              (CHDR_W),
    .MTU                 (MTU)
  ) b_PulseShapingFilter0_7 (
    .rfnoc_chdr_clk      (rfnoc_chdr_clk),
    .rfnoc_ctrl_clk      (rfnoc_ctrl_clk),
    .ce_clk              (PulseShapingFilter0_ce_clk),
    .rfnoc_core_config   (rfnoc_core_config[512*8-1:512*7]),
    .rfnoc_core_status   (rfnoc_core_status[512*8-1:512*7]),
    .s_rfnoc_chdr_tdata  ({s_PulseShapingFilter0_in_tdata }),
    .s_rfnoc_chdr_tlast  ({s_PulseShapingFilter0_in_tlast }),
    .s_rfnoc_chdr_tvalid ({s_PulseShapingFilter0_in_tvalid}),
    .s_rfnoc_chdr_tready ({s_PulseShapingFilter0_in_tready}),
    .m_rfnoc_chdr_tdata  ({m_PulseShapingFilter0_out_tdata }),
    .m_rfnoc_chdr_tlast  ({m_PulseShapingFilter0_out_tlast }),
    .m_rfnoc_chdr_tvalid ({m_PulseShapingFilter0_out_tvalid}),
    .m_rfnoc_chdr_tready ({m_PulseShapingFilter0_out_tready}),
    .s_rfnoc_ctrl_tdata  (s_PulseShapingFilter0_ctrl_tdata),
    .s_rfnoc_ctrl_tlast  (s_PulseShapingFilter0_ctrl_tlast),
    .s_rfnoc_ctrl_tvalid (s_PulseShapingFilter0_ctrl_tvalid),
    .s_rfnoc_ctrl_tready (s_PulseShapingFilter0_ctrl_tready),
    .m_rfnoc_ctrl_tdata  (m_PulseShapingFilter0_ctrl_tdata),
    .m_rfnoc_ctrl_tlast  (m_PulseShapingFilter0_ctrl_tlast),
    .m_rfnoc_ctrl_tvalid (m_PulseShapingFilter0_ctrl_tvalid),
    .m_rfnoc_ctrl_tready (m_PulseShapingFilter0_ctrl_tready)
  );
  ...
  assign s_conv32Bto2B0_in_tdata = m_ep4_out0_tdata;
  assign s_conv32Bto2B0_in_tlast = m_ep4_out0_tlast;
  assign s_conv32Bto2B0_in_tvalid = m_ep4_out0_tvalid;
  assign m_ep4_out0_tready = s_conv32Bto2B0_in_tready;

  assign s_ep4_in0_tdata = m_conv32Bto2B0_out_tdata;
  assign s_ep4_in0_tlast = m_conv32Bto2B0_out_tlast;
  assign s_ep4_in0_tvalid = m_conv32Bto2B0_out_tvalid;
  assign m_conv32Bto2B0_out_tready = s_ep4_in0_tready;

  assign s_PulseShapingFilter0_in_tdata = m_ep5_out0_tdata;
  assign s_PulseShapingFilter0_in_tlast = m_ep5_out0_tlast;
  assign s_PulseShapingFilter0_in_tvalid = m_ep5_out0_tvalid;
  assign m_ep5_out0_tready = s_PulseShapingFilter0_in_tready;

  assign s_ep5_in0_tdata = m_PulseShapingFilter0_out_tdata;
  assign s_ep5_in0_tlast = m_PulseShapingFilter0_out_tlast;
  assign s_ep5_in0_tvalid = m_PulseShapingFilter0_out_tvalid;
  assign m_PulseShapingFilter0_out_tready = s_ep5_in0_tready;
  ...
  assign conv32Bto2B0_ce_clk = ce_clk;
  assign PulseShapingFilter0_ce_clk = ce_clk;
